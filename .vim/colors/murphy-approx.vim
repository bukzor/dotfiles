...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=250 gui=NONE guibg=bg guifg=#bebebe
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=85 gui=NONE guibg=bg guifg=#bebebe
