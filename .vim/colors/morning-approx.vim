...
if has("gui_running") || &t_Co == 256
    CSAhi Normal ctermbg=254 ctermfg=16 guibg=grey90 guifg=Black
    CSAhi ColorColumn term=reverse ctermbg=217 guibg=LightRed
    CSAhi Comment term=bold ctermfg=21 guifg=Blue
    CSAhi Conceal ctermbg=248 ctermfg=252 guibg=DarkGrey guifg=LightGrey
    CSAhi Constant term=underline ctermbg=255 ctermfg=201 guibg=grey95 guifg=Magenta
      CSAlink Boolean Constant
      CSAlink Character Constant
      CSAlink Float Constant
      CSAlink Number Constant
      CSAlink String Constant
    CSAhi Cursor ctermbg=46 guibg=Green
    CSAhi CursorColumn term=reverse ctermbg=252 guibg=grey80
    CSAhi CursorLine term=underline ctermbg=252 guibg=grey80
    ...
    CSAhi Special term=bold ctermbg=255 ctermfg=62 guibg=grey95 guifg=SlateBlue
    ...
    CSAhi Visual term=reverse ctermbg=252 guibg=grey80
...
elseif &t_Co == 88
    CSAhi Normal ctermbg=87 ctermfg=16 guibg=grey90 guifg=Black
    ...
    CSAhi Constant term=underline ctermbg=87 ctermfg=67 guibg=grey95 guifg=Magenta
      CSAlink Boolean Constant
      CSAlink Character Constant
      CSAlink Float Constant
      CSAlink Number Constant
      CSAlink String Constant
    CSAhi Cursor ctermbg=28 guibg=Green
    CSAhi CursorColumn term=reverse ctermbg=58 guibg=grey80
    CSAhi CursorLine term=underline ctermbg=58 guibg=grey80
    ...
    CSAhi Special term=bold ctermbg=87 ctermfg=38 guibg=grey95 guifg=SlateBlue
      CSAlink Debug Special
      CSAlink Delimiter Special
      CSAlink SpecialChar Special
      CSAlink SpecialComment Special
    ...
    CSAhi VertSplit term=reverse cterm=reverse gui=reverse
    CSAhi Visual term=reverse ctermbg=58 guibg=grey80
    CSAhi VisualNOS term=bold,underline cterm=bold,underline gui=bold,underline
