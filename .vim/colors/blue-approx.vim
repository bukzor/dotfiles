...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || (&term =~? "^konsole" && s:old_kde())
    ...
    CSAHi IncSearch term=reverse cterm=reverse ctermbg=16 ctermfg=226 gui=reverse guibg=yellow guifg=black
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi IncSearch term=reverse cterm=reverse ctermbg=16 ctermfg=76 gui=reverse guibg=yellow guifg=black
