...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=46 ctermfg=16 gui=reverse guibg=#000000 guifg=#00ff00
    ...
    CSAHi Structure term=NONE cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=#00ff00
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=28 ctermfg=16 gui=reverse guibg=#000000 guifg=#00ff00
    ...
    CSAHi Structure term=NONE cterm=NONE ctermbg=bg ctermfg=28 gui=NONE guibg=bg guifg=#00ff00
