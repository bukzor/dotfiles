...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || (&term =~? "^konsole" && s:old_kde())
    ...
    CSAHi Statement term=NONE cterm=bold ctermbg=bg ctermfg=21 gui=bold guibg=bg guifg=blue
    CSAHi Type term=NONE cterm=bold ctermbg=bg ctermfg=21 gui=bold guibg=bg guifg=blue
    ...
    CSAHi Pmenu term=NONE cterm=NONE ctermbg=152 ctermfg=fg gui=NONE guibg=LightBlue guifg=fg
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=18 ctermfg=231 gui=NONE guibg=DarkBlue guifg=White
    ...
    CSAHi StatusLine term=bold,reverse cterm=bold,reverse ctermbg=21 ctermfg=220 gui=bold,reverse guibg=gold guifg=blue
    CSAHi StatusLineNC term=reverse cterm=reverse ctermbg=21 ctermfg=220 gui=reverse guibg=gold guifg=blue
    ...
    CSAHi Visual term=reverse cterm=reverse ctermbg=250 ctermfg=16 gui=reverse guibg=fg guifg=Grey
    ...
    CSAHi Constant term=NONE cterm=NONE ctermbg=bg ctermfg=40 gui=NONE guibg=bg guifg=green3
    CSAHi Identifier term=NONE cterm=NONE ctermbg=bg ctermfg=30 gui=NONE guibg=bg guifg=cyan4
    CSAHi PreProc term=NONE cterm=NONE ctermbg=bg ctermfg=164 gui=NONE guibg=bg guifg=magenta3
    CSAHi Special term=NONE cterm=NONE ctermbg=bg ctermfg=198 gui=NONE guibg=bg guifg=deeppink
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi Statement term=NONE cterm=bold ctermbg=bg ctermfg=19 gui=bold guibg=bg guifg=blue
    CSAHi Type term=NONE cterm=bold ctermbg=bg ctermfg=19 gui=bold guibg=bg guifg=blue
    ...
    CSAHi Pmenu term=NONE cterm=NONE ctermbg=58 ctermfg=fg gui=NONE guibg=LightBlue guifg=fg
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=17 ctermfg=79 gui=NONE guibg=DarkBlue guifg=White
    ...
    CSAHi StatusLine term=bold,reverse cterm=bold,reverse ctermbg=19 ctermfg=72 gui=bold,reverse guibg=gold guifg=blue
    CSAHi StatusLineNC term=reverse cterm=reverse ctermbg=19 ctermfg=72 gui=reverse guibg=gold guifg=blue
    CSAHi VertSplit term=reverse cterm=reverse ctermbg=bg ctermfg=fg gui=reverse guibg=bg guifg=fg
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=67 gui=bold guibg=bg guifg=Magenta
    CSAHi Visual term=reverse cterm=reverse ctermbg=85 ctermfg=16 gui=reverse guibg=fg guifg=Grey
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi Constant term=NONE cterm=NONE ctermbg=bg ctermfg=24 gui=NONE guibg=bg guifg=green3
    CSAHi Identifier term=NONE cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=cyan4
    CSAHi PreProc term=NONE cterm=NONE ctermbg=bg ctermfg=50 gui=NONE guibg=bg guifg=magenta3
    CSAHi Special term=NONE cterm=NONE ctermbg=bg ctermfg=65 gui=NONE guibg=bg guifg=deeppink
