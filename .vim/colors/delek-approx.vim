...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=196 gui=NONE guibg=bg guifg=red2
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=64 gui=NONE guibg=bg guifg=red2
