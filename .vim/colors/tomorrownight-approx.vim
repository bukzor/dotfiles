...
if has("gui_running") || &t_Co == 256
    CSAhi Normal ctermbg=234 ctermfg=251 guibg=#1d1f21 guifg=#c5c8c6
    CSAhi ColorColumn term=reverse ctermbg=16 guibg=#282a2e
    ...
    CSAhi Cursor ctermbg=251 ctermfg=234 guibg=fg guifg=bg
    CSAhi CursorColumn term=reverse ctermbg=16 guibg=#282a2e
    CSAhi CursorLine term=underline ctermbg=16 guibg=#282a2e
    ...
    CSAhi FoldColumn term=standout ctermbg=234 ctermfg=18 guibg=#1d1f21 guifg=DarkBlue
    CSAhi Folded term=standout ctermbg=234 ctermfg=246 guibg=#1d1f21 guifg=#969896
    CSAhi Function ctermfg=109 guifg=#81a2be
    CSAhi Identifier term=underline ctermfg=167 guifg=#cc6666
    CSAhi Ignore ctermfg=234 guifg=bg
    ...
    CSAhi Search term=reverse cterm=reverse gui=reverse
    ...
    CSAhi StatusLine term=bold,reverse cterm=reverse ctermbg=222 ctermfg=59 gui=reverse guibg=#f0c674 guifg=#4d5057
    CSAhi StatusLineNC term=reverse cterm=reverse ctermbg=251 ctermfg=59 gui=reverse guibg=#c5c8c6 guifg=#4d5057
    CSAhi String ctermfg=143 guifg=#b5bd68
    CSAhi Structure ctermfg=139 guifg=#b294bb
    CSAhi TabLine term=underline cterm=reverse ctermbg=234 ctermfg=251 gui=reverse guibg=#1d1f21 guifg=#c5c8c6
    ...
    CSAhi Todo term=standout ctermbg=234 ctermfg=246 guibg=#1d1f21 guifg=#969896
    ...
    CSAhi VertSplit term=reverse cterm=reverse ctermbg=59 ctermfg=59 gui=reverse guibg=#4d5057 guifg=#4d5057
    ...
    CSAhi lCursor ctermbg=251 ctermfg=234 guibg=fg guifg=bg
...
elseif &t_Co == 88
    CSAhi Normal ctermbg=80 ctermfg=58 guibg=#1d1f21 guifg=#c5c8c6
    CSAhi ColorColumn term=reverse ctermbg=80 guibg=#282a2e
    ...
    CSAhi CursorColumn term=reverse ctermbg=80 guibg=#282a2e
    CSAhi CursorLine term=underline ctermbg=80 guibg=#282a2e
    ...
    CSAhi FoldColumn term=standout ctermbg=80 ctermfg=17 guibg=#1d1f21 guifg=DarkBlue
    CSAhi Folded term=standout ctermbg=80 ctermfg=37 guibg=#1d1f21 guifg=#969896
    ...
    CSAhi Statement term=bold cterm=bold ctermfg=58 gui=bold guifg=#c5c8c6
      ...
      CSAlink Keyword Statement
      CSAlink Label Statement
    CSAhi StatusLine term=bold,reverse cterm=reverse ctermbg=73 ctermfg=81 gui=reverse guibg=#f0c674 guifg=#4d5057
    CSAhi StatusLineNC term=reverse cterm=reverse ctermbg=58 ctermfg=81 gui=reverse guibg=#c5c8c6 guifg=#4d5057
    CSAhi String ctermfg=57 guifg=#b5bd68
    CSAhi Structure ctermfg=54 guifg=#b294bb
    CSAhi TabLine term=underline cterm=reverse ctermbg=80 ctermfg=58 gui=reverse guibg=#1d1f21 guifg=#c5c8c6
    CSAhi TabLineFill term=reverse cterm=reverse gui=reverse
    CSAhi TabLineSel term=bold cterm=bold gui=bold
    CSAhi Title term=bold cterm=bold ctermfg=37 gui=bold guifg=#969896
    CSAhi Todo term=standout ctermbg=80 ctermfg=37 guibg=#1d1f21 guifg=#969896
    ...
    CSAhi VertSplit term=reverse cterm=reverse ctermbg=81 ctermfg=81 gui=reverse guibg=#4d5057 guifg=#4d5057
