...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=251 ctermfg=236 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=251 ctermfg=240 gui=reverse guibg=#585858 guifg=#c5c8c6
    CSAHi PmenuSbar term=NONE cterm=NONE ctermbg=250 ctermfg=fg gui=NONE guibg=Grey guifg=fg
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=251 ctermfg=236 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=NONE ctermbg=251 ctermfg=236 gui=reverse guibg=#303030 guifg=#c5c8c6
    CSAHi TabLineSel term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=251 ctermfg=236 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=59 ctermfg=222 gui=reverse guibg=#f0c674 guifg=#5e5e5e
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=59 ctermfg=251 gui=reverse guibg=#c5c8c6 guifg=#5e5e5e
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=58 ctermfg=81 gui=reverse guibg=#585858 guifg=#c5c8c6
    CSAHi PmenuSbar term=NONE cterm=NONE ctermbg=85 ctermfg=fg gui=NONE guibg=Grey guifg=fg
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=58 ctermfg=80 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=NONE ctermbg=58 ctermfg=80 gui=reverse guibg=#303030 guifg=#c5c8c6
    CSAHi TabLineSel term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    ...
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=81 ctermfg=73 gui=reverse guibg=#f0c674 guifg=#5e5e5e
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=81 ctermfg=58 gui=reverse guibg=#c5c8c6 guifg=#5e5e5e
