...
if has("gui_running") || &t_Co == 256
    CSAhi Normal ctermbg=16 ctermfg=252 guibg=Black guifg=Grey80
    ...
    CSAhi Cursor cterm=bold ctermbg=46 ctermfg=16 gui=bold guibg=Green guifg=Black
    ...
    CSAhi Statement term=bold ctermfg=226 guifg=Yellow
    ...
    CSAhi StatusLine term=bold,reverse cterm=bold,reverse ctermbg=231 ctermfg=21 gui=bold,reverse guibg=white guifg=blue
    ...
    CSAhi Visual term=reverse cterm=bold ctermbg=248 ctermfg=238 gui=bold guibg=DarkGrey guifg=#404040
    ...
    CSAhi lCursor ctermbg=252 ctermfg=16 guibg=fg guifg=bg
...
elseif &t_Co == 88
    CSAhi Normal ctermbg=16 ctermfg=58 guibg=Black guifg=Grey80
    ...
    CSAhi Constant term=underline ctermfg=69 guifg=#ffa0a0
      ...
      CSAlink Number Constant
      CSAlink String Constant
    CSAhi Cursor cterm=bold ctermbg=28 ctermfg=16 gui=bold guibg=Green guifg=Black
    ...
    CSAhi Statement term=bold ctermfg=76 guifg=Yellow
      CSAlink Conditional Statement
      CSAlink Exception Statement
      CSAlink Keyword Statement
      CSAlink Label Statement
      CSAlink Operator Statement
      CSAlink Repeat Statement
    CSAhi StatusLine term=bold,reverse cterm=bold,reverse ctermbg=79 ctermfg=19 gui=bold,reverse guibg=white guifg=blue
    CSAhi StatusLineNC term=reverse cterm=reverse gui=reverse
    ...
    CSAhi VertSplit term=reverse cterm=reverse gui=reverse
    CSAhi Visual term=reverse cterm=bold ctermbg=84 ctermfg=80 gui=bold guibg=DarkGrey guifg=#404040
    CSAhi VisualNOS term=bold,underline cterm=bold,underline gui=bold,underline
    ...
    CSAhi lCursor ctermbg=58 ctermfg=16 guibg=fg guifg=bg
endif
