...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || (&term =~? "^konsole" && s:old_kde())
    ...
    CSAHi Comment term=NONE cterm=bold ctermbg=bg ctermfg=248 gui=bold guibg=bg guifg=DarkGrey
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi Comment term=NONE cterm=bold ctermbg=bg ctermfg=84 gui=bold guibg=bg guifg=DarkGrey
