- [x] todo.d/2025-11-26-000 (destructure docs into references.kb/)
...
- [~] todo.d/2025-12-03-000 (pivot from .d to .kb naming) — references.kb/ done, triggers/validation remain
- [ ] todo.d/2025-11-29-001 (document blocking pattern in subtask skill) — High/Low
- [x] todo.d/2025-11-26-002 (devlog template redundancy fix) — Medium/Low
