...
- Update `references.d/` to `references.kb/`
...
- [ ] Decide final skill name (llm.kb vs kb)
- [ ] Rename skill directory
- [ ] Update SKILL.md frontmatter and content
- [ ] Rename references.d/ to references.kb/
