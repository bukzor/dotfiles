...
- [x] Stage-3 hard cases (devlog 2026-05-11-000): both migrated. `audit-gitfiles` now empty (18/18).
- [ ] Fold submodule `core.worktree` absolute-path rewriting into the migration tool. Manual logic from devlog 2026-05-08-000 not yet codified; none of the 18 migrated candidates needed it but the next submodule-bearing legacy repo will.
