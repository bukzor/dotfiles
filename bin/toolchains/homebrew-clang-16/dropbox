...
# This file is part of nautilus-dropbox 2022.12.05.
#
...
def download_file_chunk(url, buf):
    ...
    opener.addheaders = [("User-Agent", "DropboxLinuxDownloader/2022.12.05")]
...
def version(argv):
    ...
    console_print("Dropbox command-line interface version: 2022.12.05")
